...
const PRODUCTS = [
  {
    ...
    name: 'AURA_NODE X1',
    price: '2499',
    desc: 'Neuro-linked acoustic processors for extreme immersive fidelity.',
    image:
  ...
  },
  {
    ...
    name: 'CHRONOS_V3',
    price: '1850',
    desc: 'Precision atomic synchronization in a aerospace-grade titanium shell.',
    image:
  ...
  },
  {
    ...
    name: 'ORBIT_CAM 4K',
    price: '1250',
    desc: 'Autonomous hovering optic array with verified edge tracking.',
    image:
        ...
        <div className="max-w-7xl mx-auto h-full flex justify-between items-center text-slate-900">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-black tracking-tighter uppercase">
              MK_<span className="text-gold">LUXE</span>
            </span>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-12">
            {['Collections', 'Atelier', 'Tech Spec', 'Vault'].map(link => (
              <a
                key={link}
                href="#"
                className="text-xs font-black uppercase tracking-[0.2em] hover:text-gold transition-colors"
              >
                {link}
              </a>
            ))}
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-500 font-medium max-w-lg mb-12 leading-relaxed">
                Engineering luxury for the digital elite. Where high-end materials meet
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-10">
            <div>
              <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter">
                ZENITH <span className="text-slate-300 italic">SELECTION</span>
              </h2>
              <p className="text-xs font-bold text-slate-500 uppercase tracking-[0.4em] mt-2">
                Precision Products for high-stakes living
              </p>
            </div>
                ...
                <div className="p-8 space-y-4">
                  <div className="flex justify-between items-center text-[10px] font-black text-slate-400 uppercase tracking-widest">
                    <span className="flex items-center gap-1">
                      <Star className="w-3 h-3 text-gold fill-gold" /> {p.rating} / 5
                    </span>
                    <span>Free Global Shipping</span>
                  </div>
                  <h3 className="text-2xl font-black uppercase tracking-tight group-hover:text-gold transition-colors">
                    {p.name}
                  </h3>
          ...
          <div className="max-w-7xl mx-auto px-8 relative z-10 flex flex-col md:flex-row items-center justify-between gap-20">
            <div className="max-w-xl">
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-10">
                THE NEW LAB <br /> FOR{' '}
                <span className="text-gold italic underline decoration-gold">PERFECTION.</span>
              </h2>
              <p className="text-lg text-slate-400 font-medium mb-12">
                Every Zenith product undergoes a 48-hour rigorous stress test against environmental,
                thermal, and mechanical anomalies. We don't just ship; we certify.
              </p>
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-[12rem] font-black italic opacity-5 leading-none select-none">
                  ZENITH
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-32">
            <div className="lg:col-span-1">
              ...
              <p className="text-sm text-slate-500 font-medium leading-relaxed">
                Modern luxury curated for the digital frontier. Built for the bold, the visionary,
                and the relentless.
              </p>
            </div>
            ...
            <FooterSection
              title="Explore"
              links={['Zenith Series', 'Archive v2', 'Limited Drops', 'Vault']}
            />
            <FooterSection
              title="Atelier"
              links={['Engineering', 'Design Lab', 'Materials', 'Sustainability']}
            />
            <FooterSection
              title="Support"
              links={['Shipping', 'Warranty', 'Concierge', 'Contact']}
            />
          </div>
      ...
      <ul className="space-y-4">
        {links.map(l => (
          <li key={l}>
            <a
              href="#"
              className="text-xs font-bold text-slate-500 uppercase tracking-widest hover:text-gold transition-colors"
            >
              {l}
            </a>
          </li>
